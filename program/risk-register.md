...
| RISK-CI-001 | HIGH | REMEDIATION_IN_PROGRESS | Main protection, selected SHA-pinned Actions, vulnerability alerts/security fixes, deterministic SBOM/provenance and keyless attestation source are active, but exact-head attestation and human review/merge are pending. | Versioned policy, 10 adversarial tests and 17 authenticated live-setting comparisons pass. | Require the new supply-chain job and GitHub OIDC attestation to pass on the published head, then preserve drift verification and human review. | WS-02 |
