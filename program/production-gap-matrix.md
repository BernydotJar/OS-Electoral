...
| Versioned REST API | `/api/v1` FastAPI health/readiness/identity surface with safe errors and contract tests | PARTIAL | Authenticated campaign-domain API, pagination/concurrency/rate controls and reviewed OpenAPI |
