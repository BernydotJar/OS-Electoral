...
| Rate limiting and abuse protection | SHIP specification `C3-SEC-002` is complete under Graph Harness; implementation remains behind human approval | NOT_IMPLEMENTED | Approve and implement PostgreSQL-backed per-principal/tenant policy classes, abuse tests and staging load evidence |
