...
Cycle 0 is complete. The War Room repository, runtime rules, strategic gates, decision log, evidence register, dashboard, and operating structure are published on the main branch.
...
| Variable | Approved Value | Status |
|---|---|---|
| 90-day objective | Build evidence, organizational structure, and territorial prioritization before scaling communication | Approved |
...
| Station | Status | Cycle 1 Responsibility |
|---|---:|---|
| Campaign Chief | Active | Protect the approved mandate and approve later strategic decisions |
...
1. What official electoral, demographic, municipal, legal, and territorial evidence is available?
...
- `research/sources/`
- `research/electoral-baseline/`
- `research/segments/`
- `territory/communities/`

Cycle 1 must not produce public campaign content, paid-media plans, voter targeting, attacks, or field-mobilization instructions.

## Definition of Done

Cycle 1 is complete when:

- available sources and campaign knowledge have been inventoried;
- each source has an owner, date, scope, evidence class, reliability assessment, and verification status;
- confirmed facts are separated from perceptions and hypotheses;
- material evidence gaps are documented;
- territorial data requirements are defined;
- the Campaign Chief receives a decision brief on the next research priority;
- unresolved strategic gates remain visible.

## Current Blocker

The next blocker is evidence intake. The campaign must identify the documents, datasets, observations, stakeholder notes, legal sources, historical results, surveys, and operational records already available.
