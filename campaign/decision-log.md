...
Use this file for decisions, not discussions.

| Date | Decision | Owner | Evidence | Impact | Reversible? | Status |
|---|---|---|---|---|---|---|
...
This entry preserves history: it records decisions already identified as human-approved in `campaign/current-state.md`; it is not a new agent approval and does not claim an original approval timestamp. The approved values are:

- 90-day objective: build evidence, organizational structure, and territorial prioritization before scaling communication;
