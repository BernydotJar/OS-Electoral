...
| TM-17 | Unauthorized production change | protected branch, required review/checks, short-lived AWS OIDC, separate environments, reviewed plan, explicit approval receipt, rollback | Protected main now requires strict checks, review, conversation resolution, linear history and admin enforcement; AWS OIDC/environments, deployment approval and rollback remain absent |
