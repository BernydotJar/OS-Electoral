...
const es = {
  ...
  notices: {
    ...
    operations_started: "Roadmap operativo creado. Ya puedes convertir la estrategia aprobada en trabajo interno gobernado.",
    operations_section_saved: "Roadmap operativo actualizado con una nueva versión. Las vistas de readiness y ruta crítica se recalcularon en backend.",
    war_room_snapshot_created: "Snapshot diario del War Room registrado como evidencia interna inmutable. No ejecuta ninguna tarea.",
    training_assigned:
  ...
  teamWorkspace: {
    ...
    coverageEyebrow: "RESPONSABILIDAD HUMANA · SESIÓN ACTUAL",
    coverageTitle: "Asume una función para poder operar trabajo interno",
    coverageBody:
      "Vincula tu identidad autenticada a una función vacante, declara capacidad y confirma tu incorporación. Sólo cambia el mapa interno de Team.",
    coverageRole: "Función que asumirás",
    coverageSelectRole: "Selecciona una función vacante",
    coverageAvailability: "Disponibilidad declarada",
    coverageAvailabilityLabels: {
      AVAILABLE: "Disponible",
      LIMITED: "Disponibilidad limitada",
    },
    coverageCapacity: "Capacidad semanal declarada (horas)",
    coverageOnboardingConfirm:
      "Confirmo que revisé el expediente de la función y acepto esta responsabilidad interna.",
    coverageBoundary:
      "Esta autoasignación usa tu identidad de sesión y el permiso exacto de mantenimiento de Team. No crea membresías, grants, acceso adicional ni efectos externos.",
    coverageAction: "Asumir función",
  ...
  operations: {
    ...
    snapshotEyebrow: "EVIDENCIA INTERNA INMUTABLE",
    ...
    prerequisitePending: "Operations se habilita cuando Strategy tiene una decisión interna vigente, Team está listo para revisión humana y al menos una función está cubierta por una persona.",
    startEyebrow: "OPERACIÓN · CREACIÓN AUTORIZADA",
    startTitle: "Crear el roadmap operativo",
    startBody: "Convierte la estrategia decidida en un registro operativo gobernado. Crear el roadmap no ejecuta tareas ni concede autoridad externa.",
    startLabel: "Nombre del roadmap",
    startAction: "Crear roadmap",
    buildEyebrow: "AUTHORING OPERATIVO · VERSIÓN ACTUAL",
    buildTitle: "Construir y mantener la operación diaria",
    buildBody: "Define estructura, responsables, dependencias y decisiones. El backend conserva la topología y recalcula readiness, bloqueos y ruta crítica.",
    mutationBoundary: "Sólo se guardan registros internos. Ninguna tarea se inicia automáticamente y ninguna decisión produce efectos externos.",
    phases: "Fases",
    ...
    newRecord: "Agregar registro",
    saveSection: "Guardar registro",
    referenceHelp: "Selecciona únicamente registros ya existentes; no se aceptan identificadores escritos manualmente.",
    name: "Nombre",
    sequence: "Secuencia",
    ...
    recordStatus: "Estado",
    ownerRole: "Función responsable",
    selectRole: "Selecciona una función de Team",
    purpose: "Propósito",
    phase: "Fase",
    selectPhase: "Selecciona una fase",
    workstream: "Workstream",
    selectWorkstream: "Selecciona un workstream",
    milestone: "Hito",
    noMilestone: "Sin hito asociado",
    completionCriteria: "Criterio de cierre",
    taskTitle: "Trabajo que debe completarse",
    executionStatus: "Estado declarado por el equipo",
    dependencies: "Dependencias existentes",
    evidenceRefs: "Evidencia vinculada",
    task: "Tarea relacionada",
    generalBlocker: "Bloqueo general del roadmap",
    severity: "Severidad",
    description: "Descripción",
    resolutionCondition: "Condición para resolver",
    decisionTitle: "Decisión requerida",
    humanRole: "Función humana que decide",
    options: "Opciones, una por línea",
    selectedDecision: "Opción seleccionada",
    noDecision: "Aún sin decisión",
    followUpTitle: "Seguimiento requerido",
    learningTitle: "Aprendizaje",
    learningNote: "Qué cambió y qué debe conservar el equipo",
    lineHelp: "Un elemento por línea.",
    phaseHelp: "Ordena el tiempo operativo en fases explícitas y verificables.",
    workstreamHelp: "Agrupa trabajo por función y asigna una función accountable ya existente en Team.",
    milestoneHelp: "Define un resultado intermedio, su criterio de cierre y una persona responsable por función.",
    taskHelp: "Conecta estrategia y evidencia con una tarea, un owner y dependencias ya registradas. Guardar no inicia la tarea.",
    blockerHelp: "Registra lo que impide avanzar y la condición objetiva que permitirá cerrarlo.",
    decisionHelp: "Primero registra alternativas. Una persona autorizada debe volver y seleccionar explícitamente una opción existente.",
    followUpHelp: "Conserva compromisos internos con responsable, fecha y estado sin contactar personas automáticamente.",
    learningHelp: "Registra aprendizaje operativo y enlázalo con evidencia ya existente para cerrar el ciclo resultado → aprendizaje.",
    phaseStatusLabels: { PLANNED: "Planificada", ACTIVE: "Activa", COMPLETE: "Completada" },
    workstreamStatusLabels: { PLANNED: "Planificado", ACTIVE: "Activo", PAUSED: "Pausado", COMPLETE: "Completado" },
    milestoneStatusLabels: { PLANNED: "Planificado", IN_PROGRESS: "En progreso", COMPLETE: "Completado" },
    taskStatusLabels: { PLANNED: "Planificada", IN_PROGRESS: "En progreso", COMPLETE: "Completada" },
    severityLabels: { CRITICAL: "Crítica", HIGH: "Alta", MEDIUM: "Media", LOW: "Baja" },
    blockerStatusLabels: { OPEN: "Abierto", RESOLVED: "Resuelto" },
    decisionStatusLabels: { REQUIRED: "Requerida", DECIDED: "Decidida", DEFERRED: "Diferida" },
    followUpStatusLabels: { OPEN: "Abierto", COMPLETE: "Completado" },
    snapshotCreateEyebrow: "WAR ROOM DIARIO · EVIDENCIA INMUTABLE",
    snapshotCreateTitle: "Registrar el snapshot de hoy",
    snapshotCreateBody: "Declara las prioridades y el seguimiento de esta revisión. CampaignOS toma tareas listas, bloqueos, decisiones y aprendizajes del roadmap actual.",
    snapshotBoundary: "El snapshot captura el estado de esta versión; no cambia estados ni ejecuta trabajo.",
    snapshotCreateAction: "Registrar snapshot",
    statusLabels: {
...
const en: Dictionary = {
  ...
  notices: {
    ...
    team_role_covered:
      "Human responsibility recorded for your session in this function. This grants no permissions and creates no memberships.",
    team_work_item_saved:
    ...
    operations_started: "Operations roadmap created. You can now turn the approved strategy into governed internal work.",
    operations_section_saved: "Operations roadmap saved with a new version. Backend readiness and critical-path views were recalculated.",
    war_room_snapshot_created: "Daily War Room snapshot recorded as immutable internal evidence. It executes no task.",
    training_assigned:
  ...
  teamWorkspace: {
    ...
    coverageEyebrow: "HUMAN RESPONSIBILITY · CURRENT SESSION",
    coverageTitle: "Take responsibility for a function before operating internal work",
    coverageBody:
      "Bind your authenticated identity to a vacant function, declare capacity, and confirm onboarding. This changes only the internal Team map.",
    coverageRole: "Function you will cover",
    coverageSelectRole: "Select a vacant function",
    coverageAvailability: "Declared availability",
    coverageAvailabilityLabels: {
      AVAILABLE: "Available",
      LIMITED: "Limited availability",
    },
    coverageCapacity: "Declared weekly capacity (hours)",
    coverageOnboardingConfirm:
      "I confirm that I reviewed the function dossier and accept this internal responsibility.",
    coverageBoundary:
      "This self-assignment uses your session identity and the exact Team maintenance grant. It creates no membership, grant, additional access, or external effect.",
    coverageAction: "Take responsibility",
  ...
  operations: {
    ...
    snapshotEyebrow: "IMMUTABLE INTERNAL EVIDENCE",
    ...
    prerequisitePending: "Operations unlocks when Strategy has a current internal decision, Team is ready for human review, and at least one function is filled by a person.",
    startEyebrow: "OPERATIONS · AUTHORIZED CREATION",
    startTitle: "Create the operations roadmap",
    startBody: "Turn the decided strategy into a governed operations record. Creating the roadmap neither executes tasks nor grants external authority.",
    startLabel: "Roadmap name",
    startAction: "Create roadmap",
    buildEyebrow: "OPERATIONS AUTHORING · CURRENT VERSION",
    buildTitle: "Build and maintain daily operations",
    buildBody: "Define structure, owners, dependencies, and decisions. The backend preserves topology and recalculates readiness, blockers, and critical path.",
    mutationBoundary: "Only internal records are saved. No task starts automatically and no decision produces external effects.",
    phases: "Phases",
    workstreams: "Workstreams",
    ...
    learning: "Learning",
    newRecord: "Add record",
    saveSection: "Save record",
    referenceHelp: "Select only existing records; manually typed identifiers are not accepted.",
    name: "Name",
    sequence: "Sequence",
    ...
    recordStatus: "Status",
    ownerRole: "Responsible function",
    selectRole: "Select a Team function",
    purpose: "Purpose",
    phase: "Phase",
    selectPhase: "Select a phase",
    workstream: "Workstream",
    selectWorkstream: "Select a workstream",
    milestone: "Milestone",
    noMilestone: "No linked milestone",
    completionCriteria: "Completion criteria",
    taskTitle: "Work to complete",
    executionStatus: "Team-declared status",
    dependencies: "Existing dependencies",
    evidenceRefs: "Linked evidence",
    task: "Related task",
    generalBlocker: "General roadmap blocker",
    severity: "Severity",
    description: "Description",
    resolutionCondition: "Resolution condition",
    decisionTitle: "Required decision",
    humanRole: "Human function making the decision",
    options: "Options, one per line",
    selectedDecision: "Selected option",
    noDecision: "No decision yet",
    followUpTitle: "Required follow-up",
    learningTitle: "Learning",
    learningNote: "What changed and what the team should retain",
    lineHelp: "One item per line.",
    phaseHelp: "Order the operating timeline into explicit, verifiable phases.",
    workstreamHelp: "Group work by function and assign an accountable function that already exists in Team.",
    milestoneHelp: "Define an intermediate outcome, its completion criteria, and a responsible function.",
    taskHelp: "Connect strategy and evidence to a task, an owner, and existing dependencies. Saving does not start the task.",
    blockerHelp: "Record what prevents progress and the objective condition that will allow it to close.",
    decisionHelp: "Record alternatives first. An authorized person must return and explicitly select an existing option.",
    followUpHelp: "Keep internal commitments with an owner, date, and status without automatically contacting anyone.",
    learningHelp: "Record operating learning and link it to existing evidence to close the result → learning loop.",
    phaseStatusLabels: { PLANNED: "Planned", ACTIVE: "Active", COMPLETE: "Complete" },
    workstreamStatusLabels: { PLANNED: "Planned", ACTIVE: "Active", PAUSED: "Paused", COMPLETE: "Complete" },
    milestoneStatusLabels: { PLANNED: "Planned", IN_PROGRESS: "In progress", COMPLETE: "Complete" },
    taskStatusLabels: { PLANNED: "Planned", IN_PROGRESS: "In progress", COMPLETE: "Complete" },
    severityLabels: { CRITICAL: "Critical", HIGH: "High", MEDIUM: "Medium", LOW: "Low" },
    blockerStatusLabels: { OPEN: "Open", RESOLVED: "Resolved" },
    decisionStatusLabels: { REQUIRED: "Required", DECIDED: "Decided", DEFERRED: "Deferred" },
    followUpStatusLabels: { OPEN: "Open", COMPLETE: "Complete" },
    snapshotCreateEyebrow: "DAILY WAR ROOM · IMMUTABLE EVIDENCE",
    snapshotCreateTitle: "Record today's snapshot",
    snapshotCreateBody: "Declare the priorities and follow-up for this review. CampaignOS takes ready tasks, blockers, decisions, and learning from the current roadmap.",
    snapshotBoundary: "The snapshot captures this version's state; it changes no status and executes no work.",
    snapshotCreateAction: "Record snapshot",
    statusLabels: {
