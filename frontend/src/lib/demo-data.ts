...
export const demoTeamWorkspace: TeamWorkspaceReadEvidence = {
  ...
  workspace: {
    ...
    status: "SETUP_REQUIRED",
    checks: [
      { key: "organization_template", complete: true, reason_code: "ORGANIZATION_TEMPLATE_SELECTED" },
      { key: "role_cards", complete: false, reason_code: "ROLE_CARDS_MISSING" },
      { key: "accountability", complete: false, reason_code: "RACI_ACCOUNTABILITY_MISSING" },
      { key: "availability", complete: false, reason_code: "AVAILABILITY_GAPS_REMAIN" },
      { key: "vacancies", complete: false, reason_code: "VACANCIES_NOT_ASSESSED" },
      { key: "onboarding", complete: false, reason_code: "ONBOARDING_INCOMPLETE" },
      { key: "training", complete: false, reason_code: "TRAINING_INCOMPLETE" },
      { key: "access_review", complete: false, reason_code: "ACCESS_RECOMMENDATIONS_PENDING" },
    ],
    completed_checks: 1,
    total_checks: 8,
    filled_role_count: 0,
