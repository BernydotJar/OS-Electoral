      ...
      work_items: [
        {
          ...
          next_action: "Review the evidence package with campaign leadership.",
          blocker: null,
          evidence: ["Evidence register", "Decision brief"],
          cadence: "WEEKLY",
          check_in_note: "The work remains on track.",
          last_check_in_at: "2026-07-27T18:00:00Z",
          assignments: [
